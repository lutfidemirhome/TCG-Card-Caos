...
Shader "Toony Colors Pro 2/User/SimpleTriplanar2RimLight"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		...
		[NoScaleOffset] _TriCeiling ("Ceiling", 2D) = "white" {}
		_TriplanarOrigin ("Triplanar Origin", Vector) = (0,0,0,0)
		...
		_Frequency ("Frequency", Range(0.01, 10)) = 1.0
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float3 positionWS = input.worldPosAndFog.xyz - _TriplanarOrigin.xyz;
				...
				half2 uv_ground = positionWS.xz * _Frequency;
				half2 uv_sideX = positionWS.zy * _Frequency;
				half2 uv_sideZ = positionWS.xy * _Frequency;
				...
				//ceiling
				fixed4 tex_ceiling = ( TCP2_TEX2D_SAMPLE(_TriCeiling, _TriCeiling, uv_ground).rgba );
				...
				float triplanar_ceiling_lerp = smoothstep(positionWS.y - __ceilingSmoothness, positionWS.y, __ceilingMax) - smoothstep(positionWS.y, positionWS.y + __ceilingSmoothness, __ceilingMin);
...
/* TCP_DATA u config(ver:"2.9.16";unity:"2022.3.47f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","TRIPLANAR","TRIPLANAR_CEILING","TRIPLANAR_CEILING_MINMAX","TRIPLANAR_HEIGHT_GROUND","TEMPLATE_LWRP","RIM","RIM_VERTEX","RIM_DIR","RIM_DIR_PERSP_CORRECTION","RIM_LIGHTMASK","RIM_SHADER_FEATURE"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 767c9da2ab439c9c940f32a66ddcab8b */
