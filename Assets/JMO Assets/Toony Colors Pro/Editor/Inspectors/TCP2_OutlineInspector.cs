...
public class TCP2_OutlineInspector : MaterialEditor
{
	...
	private bool ShaderMaterialPropertyImpl(MaterialProperty property, string filter = null)
	{
		...
		//GUI
		switch(TCP2_MaterialPropertyCompat.GetPropertyType(property))
		{
		...
		default:
			EditorGUILayout.LabelField("Unknown Material Property Type: " + TCP2_MaterialPropertyCompat.GetPropertyType(property));
			break;
		}
