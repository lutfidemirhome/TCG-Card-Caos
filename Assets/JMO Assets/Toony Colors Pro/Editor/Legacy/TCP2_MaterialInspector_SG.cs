		...
		if(materialEditor.isVisible && !mShader.hasMultipleDifferentValues && mShader.objectReferenceValue != null)
		{
			...
			foreach (var p in properties)
			{
				...
				else
				{
					...
					if(visible && (TCP2_MaterialPropertyCompat.GetPropertyFlags(p) & (UnityEngine.Rendering.ShaderPropertyFlags.PerRendererData | UnityEngine.Rendering.ShaderPropertyFlags.HideInInspector)) == UnityEngine.Rendering.ShaderPropertyFlags.None)
