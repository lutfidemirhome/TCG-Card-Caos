...
namespace PluginMaster
{
    ...
    public class UnoverlapToolWindow : BaseToolWindow
    {
        ...
        private (EntityId objId, Vector3 offset)[] _offsets = null;
        private System.Collections.Generic.Dictionary<EntityId, GameObject> _objDictionary
        ...
        {
#if UNITY_6000_3_OR_NEWER
            _objDictionary = selection.ToDictionary(obj => obj.GetEntityId());
            var bounds = selection.Select(obj => (obj.GetEntityId(),
...
#if UNITY_6000_3_OR_NEWER
        private void OnDone((EntityId objId, Vector3 offset)[] positions)
#else
