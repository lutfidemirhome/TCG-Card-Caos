#!/usr/bin/env python3
"""Import trainer_ally / trainer_equip / trainer_gear / trainer_zone cards and 100-slot cabinets.
...
FIRE_COMMON_CAT_GUID = "ff54a83bda314fc595cf6dfda86006b7"
...
CATEGORIES = [
    {
        "id": "trainer_ally",
        "art_folder": "Trainer_Ally_Cards",
        "prefab": "Cabinets_TrainerAlly",
        "instance_id": 910000101,
        "pos": (12.1, 0.06000042, -8.32),
    },
    {
        "id": "trainer_equip",
        "art_folder": "Trainer_Equip_Cards",
        "prefab": "Cabinets_TrainerEquip",
        "instance_id": 910000102,
        "pos": (12.1, 0.06000042, -10.33),
    },
    {
        "id": "trainer_gear",
        "art_folder": "Trainer_Gear_Cards",
        "prefab": "Cabinets_TrainerGear",
        "instance_id": 910000103,
        "pos": (10.46, 0.06000042, -8.32),
    },
    {
        "id": "trainer_zone",
        "art_folder": "Trainer_Zone_Cards",
        "prefab": "Cabinets_TrainerZone",
        "instance_id": 910000104,
        "pos": (10.46, 0.06000042, -10.33),
    },
]
...
def copy_cabinets():
    ...
    dst_dir = CABINETS / "Cabinets_Trainer"
    ensure_folder_meta(dst_dir)
...
def place_cabinets_in_scene():
    ...
    if "Cabinets_TrainerAlly" in scene_text:
        print("MainScene already has trainer cabinets; skipping scene insert")
        return
    ...
    print("Placed 4 trainer cabinets in MainScene")
...
def main():
    ...
    print("Done. Trainer categories are catalog + cabinet only (no ground spawn).")
