#!/usr/bin/env python3
"""Import mythic gold card sets and 30-slot (rare-size) cabinets.
...
CATEGORIES = [
    {
        "id": "fairy_mythic_gold",
        "art_folder": "Fairy_Mythic_Gold_Cards",
        "cab_dir": "Cabinets_Fairy",
        "prefab": "Cabinets_FairyMythicGold",
        "instance_id": 910000401,
        "pos": (12.1, 0.060000658, -11.95),
    },
    {
        "id": "fire_mythic_gold",
        "art_folder": "Fire_Mythic_Gold_Cards",
        "cab_dir": "Cabinets_Fire",
        "prefab": "Cabinets_FireMythicGold",
        "instance_id": 910000402,
        "pos": (10.46, 0.060000658, -11.95),
    },
    {
        "id": "flying_mythic_gold",
        "art_folder": "Flying_Mythic_Gold_Cards",
        "cab_dir": "Cabinets_Flying",
        "prefab": "Cabinets_FlyingMythicGold",
        "instance_id": 910000403,
        "pos": (8.82, 0.060000658, -11.95),
    },
    {
        "id": "ice_mythic_gold",
        "art_folder": "Ice_Mythic_Gold_Cards",
        "cab_dir": "Cabinets_Ice",
        "prefab": "Cabinets_IceMythicGold",
        "instance_id": 910000404,
        "pos": (7.18, 0.060000658, -11.95),
    },
    {
        "id": "rock_mythic_gold",
        "art_folder": "Rock_Mythic_Gold_Cards",
        "cab_dir": "Cabinets_Rock",
        "prefab": "Cabinets_RockMythicGold",
        "instance_id": 910000405,
        "pos": (5.54, 0.060000658, -11.95),
    },
]
...
def place_cabinets_in_scene():
    ...
    if "Cabinets_FairyMythicGold" in scene_text:
        print("MainScene already has mythic gold cabinets; rewiring guids if needed")
    ...
    SCENE_PATH.write_text(scene_text, encoding="utf-8")
    print("Placed 5 mythic gold cabinets in MainScene")
...
def main():
    ...
    print("== Import mythic gold cards ==")
    ...
    print("Done. Mythic gold categories are catalog + cabinet only (no ground spawn).")
